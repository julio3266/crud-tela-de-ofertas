...
import '../new-user/CadastroUser.css';
...
export default function CadastroUser(){
    ...
    return(
        ...
        <section className="col-md-12 mt-5 d-flex align-items-center">
            <div className="card card-body mt-5">
                <div className="form-cadastro">
                    
                    <form className="text-center form-login mx-auto mt-5 col-md-6">
                        ...
                        : <button onClick={cadastrar} type="button" className="btn btn-outline-primary btn-lg btn-block mt-3 mb-5 btn-cadastro">Cadastrar</button>
                        }
